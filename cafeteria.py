...
if not os.path.exists(tag_file):
    default_tags = {
        "🐷 돼지고기(Pork/猪肉)": ["돼지", "돈", "제육", "삼겹", "햄", "소시지", "후랑크", "베이컨", "순대", "탕수육", "돈까스", "카츠"],
        "🐄 소고기(Beef/牛肉)": ["소고기", "우육", "불고기", "차돌", "설렁탕", "사골", "육개장", "갈비", "함박", "우삼겹", "규동"],
        "🐔 닭고기(Chicken/鸡肉)": ["닭", "치킨", "가라아게", "찜닭", "깐풍기", "닭갈비", "스리라차치킨"],
        "🦆 오리고기(Duck/鸭肉)": ["오리"],
        "🐟 해산물(Seafood/海鲜)": ["오징어", "새우", "생선", "참치", "멸치", "꽁치", "고등어", "연어", "어묵", "명태", "쭈꾸미", "게맛살", "맛살", "굴소스", "해파리", "다시마", "미역"],
        "🥚 계란(Egg/鸡蛋)": ["계란", "달걀", "후라이", "오므라이스", "지단", "메추리알"],
        "🥛 유제품(Dairy/乳制品)": ["우유", "치즈", "요구르트", "크림", "버터"],
        "🥜 콩/견과(Soy&Nuts/大豆&坚果)": ["땅콩", "아몬드", "호두", "두부", "유부", "된장", "청국장", "콩나물", "비지", "콩가루"],
        "🌾 밀가루(Wheat/小麦)": ["면", "멘", "국수", "소면", "라면", "우동", "스파게티", "파스타", "빵", "샌드위치", "튀김", "만두"]
    }
